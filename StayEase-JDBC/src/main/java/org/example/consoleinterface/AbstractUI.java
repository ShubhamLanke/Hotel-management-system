...
//        while (true) {
//            menuHandler.displayMenu(loggedInUser,"Super Admin Dashboard", new String[]{
...
//        MenuHandler menuHandler = new MenuHandler(scanner);
//        while (true) {
//            menuHandler.displayMenu(loggedInUser,"Admin Dashboard", new String[]{
...
//        MenuHandler menuHandler = new MenuHandler(scanner);
//        while (true) {
//            menuHandler.displayMenu(loggedInUser,"Staff Dashboard", new String[]{
