...
//
//        // Set user for each guest (bi-directional mapping)
////        User newGuestUser = new GuestUser(null, name, email, password, true, guests);
//        for (Guest guest : guests) {
//            guest.setUser(fetchNewlyRegisteredUser);
//            System.out.println();
//            userController.addAccompaniedGuest((Guest) guests);// attach the guest to this GuestUser
//        }
//
////        Response response = userController.createUser(newGuestUser);
